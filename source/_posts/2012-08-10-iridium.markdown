...
<a href="Sinonjs.org" target="_blank">sinon.js</a> gets included for you in **test/support** as a nice opinionated default to assist with mocking out any asyn ajax calls.

##Conclusion##
The front end project space has been crying out for a project like this.  Rails provides uniformity and opinionated guidance every time you create a project.  We need the same in the front end project space.
